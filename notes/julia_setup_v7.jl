...
#######################################################
# Fezzik will let you trace which packages are compiled,
# this is just the installation of Fezzik here, see
...
Pkg.add("SpecialFunctions")  # for e.g. logfactorial
Pkg.add("Rmath")
using Rmath
Pkg.build("Rmath")
...
Pkg.add("FixedPointNumbers") # for Statistics
Pkg.add("GeometryTypes")  # for Plots
Pkg.add("GeometryBasics")  # for Plots
