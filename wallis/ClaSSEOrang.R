...
classe_params[param_names=="lambda1111"] = yprob * birthRate
classe_params[param_names=="lambda2222"] = yprob * birthRate
classe_params[param_names=="lambda3333"] = 0
...
classe_lambdas_to_df(classe_params, k=4)
