...
dev <- function(a=0.1, r=0.2, N, x, return_deviance=FALSE)
{
  ...
  lnl_branching_times = -2 * sum(log(exp(r * sptimes[3:N]) - a))
...
# (ranges A, A, A, B)
#states = c(1, 1, 1, 1)
states = c(0, 1, 1, 1) # 4 states for 4 tips
...
# LnLs1  -18.444224 -17.281562 -1.162662  0.341400    0.312653    1.406938
# LnLs2  -19.107121 -17.281562 -1.825559 -0.321500    0.161128    0.725074
# LnLs3   -22.60523 -17.281562 -5.323667   -3.8196  0.00487484   0.0219368
# LnLs4  -19.770462 -17.281562   -2.4889 -0.984800   0.0830012    0.373505
# LnLs5  -19.107121 -17.281562 -1.825559 -0.321500    0.161128    0.725074
# LnLs6  -18.695544 -17.281562 -1.413982 0.0901000    0.243173    1.094279
# LnLs1t -10.825589 -17.281562  6.455973    7.9601   636.49287   2864.2179
# LnLs2t -10.825539 -17.281562  6.456023    7.9601   636.52443   2864.3599
# LnLs3t -10.822255 -17.281562  6.459307    7.9634   638.61848   2873.7832
# LnLs4t -10.825443 -17.281562  6.456119    7.9602   636.58573   2864.6358
# LnLs5t -10.825539 -17.281562  6.456023    7.9601   636.52443   2864.3599
# LnLs6t -10.825574 -17.281562  6.455988    7.9601   636.50246   2864.2611
...
one_step_result
# [[1]]
# [1]  1.200000  2.400000  0.400000 -2.822222
...
condlikes_of_each_treeState_BRANCHTOP_AT_NODE[1,numstates] = 0	# chimp
...
# [5,] 0.9665046 0.9941391 0.3173803 0.004874842
# [6,] 0.8988459 0.9775416 0.2597286 0.009541766
# [7,] 0.6888798 0.8799765 0.1518462 0.015528271
...
# [5,] 0.9665046 0.9941391  NaN  NaN
# [6,] 0.8988459 0.9775416  NaN  NaN
# [7,] 0.6888798 0.8799766  NaN  NaN
...
# [,1]      [,2]      [,3]      [,4]
# [1,] 0.6888798 0.8799766       NaN       NaN
# [2,] 0.6888798 0.8799766 0.8862882 0.1137118
# [3,] 0.8988459 0.9775416 0.6725994 0.3274006
# [4,] 0.9665046 0.9941391 0.8042129 0.1957871
# [5,] 0.0000000 0.0000000 0.0000000 0.0000000
# [6,] 0.9665046 0.9941391       NaN       NaN
# [7,] 0.8988459 0.9775416       NaN       NaN
condlikesProbs_treeStates_BRANCHBOTTOM_BELOW_NODE_DOWNPASS
# [,1]      [,2]      [,3]      [,4]
# [1,] 0.6888798 0.8799766       NaN       NaN
# [2,] 0.6888798 0.8799766 0.8862882 0.1137118
...
# [,1]      [,2]        [,3]        [,4]
# [1,] 0.6888798 0.8799766 0.000000000 0.000000000
# [2,] 0.6888798 0.8799766 0.192606862 0.024711694
# [3,] 0.8988459 0.9775416 0.019593574 0.009537547
# [4,] 0.9665046 0.9941391 0.006689482 0.001628567
# [5,] 0.0000000 0.0000000 0.000000000 0.000000000
# [6,] 0.9665047 0.9941391         NaN         NaN
# [7,] 0.8988459 0.9775416         NaN         NaN
...
lnls
#         NA -1.526391 -3.535948 -4.789328        NA        NA        NA
sum(lnls, na.rm=TRUE)
# -9.851667
sum(lnls, na.rm=TRUE)
...
lq
sum(lq)
# -1.526391 -2.014554 -3.535949 -4.789328  0.000000 -2.402859 -3.012482
# -17.28156
